...
const Documents = () => {
    ...
    const debouncedSearch = useCallback((query) => {
        ...
        if (query.trim() === '') {
            // If search is cleared, load all documents with current filter
            dispatch(documentStatus(filter === 'all' ? null : filter));
            return;
        }
    ...
    const handleFilterChange = (newFilter) => {
        setFilter(newFilter);
        if (searchTerm.trim() === '') {
            // Only apply server-side filtering when not searching
                            ...
                            {(searchLoading || statusLoading) ? (
                                ...
                                <AnimatePresence>
                                    {displayDocuments.map((document) => {
                                        ...
                                        >
                                            {/* Your existing document item JSX */}
